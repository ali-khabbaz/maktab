"undefined" === typeof jwplayer && (jwplayer = function () {
    ...
    b.getAbsolutePath = function (a, e) {
      ...
      if(b.exists(a)) {
        ...
        var d = e.substring(c.length,
          ...
          h;
        0 === a.indexOf("/") ? h = a.split("/") : (h = e.split("?")[0], h = h.substring(c.length + d.length + 1, h.lastIndexOf(
          "/")), h = h.split("/").concat(a.split("/")));
        for(var p = [], g = 0; g < h.length; g++) h[g] && (b.exists(h[g]) && "." !== h[g]) && (".." === h[g] ? p.pop() :
          p.push(h[g]));
        return c + d + "/" + p.join("/")
      }
    };
    ...
    b.isAndroid = function (a,
      e) {
      return e && g(/chrome\/[123456789]/i) && !g(/chrome\/18/) ? !1 : a ? (b.isInt(a) && !/\./.test(a) && (a = "" +
        a + "."), g(RegExp("Android\\s*" + a, "i"))) : g(/Android/i)
    };
    b.isMobile = function () {
    ...
    b.saveCookie = function (a, e) {
      document.cookie = "jwplayer." + a + "=" + e + "; path=/"
    };
    ...
    b.translateEventResponse = function (a, e) {
      ...
      if(a === f.events.JWPLAYER_FULLSCREEN && !c.fullscreen) c.fullscreen = "true" === c.message, delete c.message;
        ...
        delete c.data;
        c = b.extend(c, d)
      } else "object" === typeof c.metadata && b.deepReplaceKeyName(c.metadata, ["__dot__", "__spc__", "__dsh__",
        "__default__"], [".", " ", "-", "default"]);
    ...
    b.flashVersion = function () {
      ...
      var a = navigator.plugins,
        e;
      try {
        if("undefined" !== a && (e = a["Shockwave Flash"])) return parseInt(e.description.replace(/\D+(\d+)\..*/,
          "$1"), 10)
      } catch(c) {}
    ...
    b.foreach = function (a, e) {
      var c, d;
      for(c in a) "function" === b.typeOf(a.hasOwnProperty) ? a.hasOwnProperty(c) && (d = a[c], e(c, d)) : (d = a[c],
        e(c, d))
    };
    b.isHTTPS = function () {
    ...
    b.parseXML = function (a) {
      ...
      try {
        if(window.DOMParser) {
          if(c = (new window.DOMParser).parseFromString(a, "text/xml"), c.childNodes && c.childNodes.length &&
            "parsererror" === c.childNodes[0].firstChild.nodeName) return
    ...
    b.seconds = function (a) {
      ...
      var c = a.split(":"),
        b = 0;
      "s" === a.slice(-1) ? b = parseFloat(a) : "m" === a.slice(-1) ? b = 60 * parseFloat(a) : "h" === a.slice(-1) ?
        b = 3600 * parseFloat(a) : 1 < c.length ? (b = parseFloat(c[c.length - 1]), b += 60 * parseFloat(c[c.length -
          2]), 3 === c.length && (b += 3600 * parseFloat(c[c.length - 3]))) : b = parseFloat(a);
      return b
    };
    ...
    function l(a, b, e) {
      ...
      e = e ? " !important" : "";
      return "string" === typeof b && isNaN(b) ? /png|gif|jpe?g/i.test(b) && 0 > b.indexOf("url") ? "url(" + b + ")" :
        b + e : 0 === b || "z-index" === a || "opacity" === a ? "" + b + e : /color/i.test(a) ? "#" + c.pad(b.toString(
          16).replace(/^0x/i, ""), 6) + e : Math.ceil(b) +
        "px" + e
    }
    ...
    var q = c.css = function (c, b, f) {
      ...
      var u = !1,
        q, n;
      for(q in b) n = l(q, b[q], f), "" !== n ? n !== r[q] && (r[q] = n, u = !0) : void 0 !== r[q] && (delete r[q],
        u = !0);
      if(u) {
        if(!g[c]) {
          b =
      ...
      this.load = function () {
        if(k === d.NEW) {
          ...
          g.onload = g.onreadystatechange = function (a) {
            if(!q && (!this.readyState || "loaded" === this.readyState || "complete" === this.readyState)) q = !
              0, j(a), g.onload = g.onreadystatechange =
    ...
    f.xmlAttribute = function (d, f) {
      for(var b = 0; b < d.attributes.length; b++)
        if(d.attributes[b].name && d.attributes[b].name.toLowerCase() === f.toLowerCase()) return d.attributes[b].value
          .toString();
      return ""
    };
    f.extension = function (d) {
      ...
      var f;
      f = -1 < d.indexOf("(format=m3u8-") ? "m3u8" : !1;
      if(f) return f;
  ...
  function (f) {
    ...
    f.touch = function (b) {
      function j(b) {
        b.type === l ? (a = !0, r = g(h.DRAG_START, b)) : b.type === d ? a && (q || (c(h.DRAG_START, b, r), q = !0),
          c(h.DRAG, b)) : (a && (q ? c(h.DRAG_END, b) : (b.cancelBubble = !0, c(h.TAP, b))), a = q = !1, r = null)
      }

      function c(a, c, b) {
        if(e[a] && (c.preventManipulation && c.preventManipulation(), c.preventDefault && c.preventDefault(), c = b ?
            b : g(a, c))) e[a](c)
      }

      function g(a, c) {
        var b = null;
        c.touches && c.touches.length ? b = c.touches[0] : c.changedTouches && c.changedTouches.length && (b = c.changedTouches[
          0]);
        if(!b) return null;
    ...
    f.key = function (d) {
      ...
      try {
        ...
        (l = c[0]) ? /^(free|pro|premium|enterprise|ads)$/i.test(l) ?
          (b = c[1], c[2] && 0 < parseInt(c[2]) && (j = new Date, j.setTime(String(c[2])))) : l = "invalid": l =
          "free"
      } catch(g) {
        l = "invalid"
      }
  ...
  function (f) {
    ...
    d.encrypt = function (j, c) {
      ...
      1 >= g.length && (g[1] = 0);
      for(var k = d.strToLongs(b.encode(c).slice(0, 16)), a = g.length, e = g[a - 1], f = g[0], q, h = Math.floor(6 +
          52 / a), p = 0; 0 < h--;) {
        p += 2654435769;
        q = p >>> 2 & 3;
        for(var m = 0; m < a; m++) f = g[(m + 1) % a], e = (e >>> 5 ^ f << 2) + (f >>> 3 ^ e << 4) ^ (p ^ f) + (k[m &
          3 ^ q] ^ e), e = g[m] += e
      }
      g = d.longsToStr(g);
      return l.encode(g)
    ...
    d.decrypt = function (j, c) {
      if(0 == j.length) return "";
      for(var g = d.strToLongs(l.decode(j)), k = d.strToLongs(b.encode(c).slice(0, 16)), a = g.length, e = g[a - 1],
          f = g[0], q, h = 2654435769 * Math.floor(6 + 52 / a); 0 != h;) {
        q = h >>> 2 & 3;
        for(var p = a - 1; 0 <= p; p--) e = g[0 < p ? p - 1 : a - 1], e = (e >>> 5 ^ f << 2) + (f >>> 3 ^ e << 4) ^
          (h ^ f) + (k[p & 3 ^ q] ^ e), f = g[p] -= e;
        h -= 2654435769
      }
      g = d.longsToStr(g);
      g = g.replace(/\0+$/, "");
    ...
    d.strToLongs = function (b) {
      for(var c = Array(Math.ceil(b.length / 4)), d = 0; d < c.length; d++) c[d] = b.charCodeAt(4 * d) + (b.charCodeAt(
        4 *
        d + 1) << 8) + (b.charCodeAt(4 * d + 2) << 16) + (b.charCodeAt(4 * d + 3) << 24);
      return c
    };
    d.longsToStr = function (b) {
      for(var c = Array(b.length), d = 0; d < b.length; d++) c[d] = String.fromCharCode(b[d] & 255, b[d] >>> 8 &
        255, b[d] >>> 16 & 255, b[d] >>> 24 & 255);
      return c.join("")
    };
    var l = {
        ...
        encode: function (d, c) {
          ...
          for(h = 0; h < p.length; h += 3) g = p.charCodeAt(h),
            k = p.charCodeAt(h + 1), a = p.charCodeAt(h + 2), e = g << 16 | k << 8 | a, g = e >> 18 & 63, k = e >>
            12 & 63, a = e >> 6 & 63, e &= 63, f[h / 3] = m.charAt(g) + m.charAt(k) + m.charAt(a) + m.charAt(e);
          f = f.join("");
        ...
        decode: function (d, c) {
          ...
          var g, k, a, e, f, q = [],
            h, p = l.code;
          h = c ? b.decode(d) : d;
          for(var m = 0; m < h.length; m += 4) g = p.indexOf(h.charAt(m)), k = p.indexOf(h.charAt(m + 1)), e = p.indexOf(
              h.charAt(m + 2)), f = p.indexOf(h.charAt(m + 3)), a = g << 18 | k << 12 | e << 6 | f, g = a >>> 16 &
            255, k = a >>> 8 & 255, a &= 255, q[m / 4] = String.fromCharCode(g,
              k, a), 64 == f && (q[m / 4] = String.fromCharCode(g, k)), 64 == e && (q[m / 4] = String.fromCharCode(
              g));
          e = q.join("");
    ...
    f.plugin = function (b) {
      ...
      this.registerPlugin =
        function (b, c, g, f) {
          ...
          r = c;
          g && f ? (a = f, e = g) : "string" === typeof g ? a = g : "function" === typeof g ? e = g : !g && !f && (
            a = b);
          k = d.loaderstatus.COMPLETE;
          h.sendEvent(l.COMPLETE)
        };
    ...
    f.plugins.pluginloader = function (c,
      ...
      function a() {
        if(!w && ((!h || 0 === b.keys(h).length) && f(), !q)) {
          ...
          d.foreach(h, function (b) {
            ...
            var e = c.getTarget(),
              c = c.getStatus();
            c === d.loaderstatus.LOADING || c === d.loaderstatus.NEW || (b && !d.versionCheck(e) && u.sendEvent(
              l.ERROR, {
      ...
      this.load = function () {
        if(!(d.exists(g) && "object" !== d.typeOf(g))) {
          ...
          j(g, function (b) {
            d.exists(b) && (b = c.addPlugin(b), b.addEventListener(l.COMPLETE, a), b.addEventListener(l.ERROR,
              e))
          });
          var b = c.getPlugins();
          j(b, function (a, b) {
  ...
  function (f) {
    ...
    (d.jwparser = function () {}).parseEntry = function (l, b) {
      ...
      if(j.length) {
        b.sources = [];
        for(k = 0; k < j.length; k++) 0 < j[k].file.length && (j[k]["default"] = "true" === j[k]["default"] ? !0 :
          !1, j[k].label.length || delete j[k].label, b.sources.push(j[k]))
      }
      if(c.length) {
        b.tracks = [];
        for(k = 0; k < c.length; k++) 0 < c[k].file.length && (c[k]["default"] = "true" === c[k]["default"] ? !0 :
          !1, c[k].kind = !c[k].kind.length ? "captions" : c[k].kind, c[k].label.length || delete c[k].label, b.tracks
          .push(c[k]))
      }
      return b
    }
  ...
  function (f) {
    var d = f.item = function (l) {
      ...
      for(c = 0; c < j.sources.length; c++) g = j.sources[c]["default"], j.sources[c]["default"] = g ? "true" === g
        .toString() : !1, j.sources[c] = new f.source(j.sources[c]);
        ...
        function k() {
          if(!z) {
            ...
            if(!x)
              ...
              p.fallback ? (e = "No suitable players found and fallback enabled", q(e, !0), l.log(e), new c.download(
                F, p, r)) : (e = "No suitable players found and fallback disabled", q(e, !1), l.log(e))
            }
          }
        }
  ...
  function (f) {
    function d(c) {
      if(c.playlist)
        ...
        f.sources || (c.levels ? (f.sources = c.levels, delete c.levels) : (d = {}, l(c, d, "file"), l(c, d, "type"),
          f.sources = d.file ? [d] : []));
        c.playlist = [new j(f)]
      }
    }
    ...
    (f.embed.config = function (c) {
      ...
      c.listbar && (c.playlistsize = c.listbar.size, c.playlistposition = c.listbar.position, c.playlistlayout = c.listbar
        .layout);
      ...
      if("string" !== typeof k || !b.exists(k)) g = 0;
        ...
        var a = k.indexOf(":"); - 1 === a ? g = 0 : (g = parseFloat(k.substr(0, a)), k = parseFloat(k.substr(a + 1)),
          g = 0 >= g || 0 >= k ? 0 : 100 * (k / g) + "%")
  ...
  function (f) {
    ...
    f.embed.download = function (b, f, c) {
      ...
      if(p && p.length) {
        m = p[0];
        w = m.sources;
        for(p = 0; p < w.length; p++) u = w[p], u.file && (t = u.type || l.extensionmap.extType(l.extension(u.file)),
          0 <= l.indexOf(k, t) ? (a = u.file, q = m.image) : l.isYouTube(u.file, t) && (h = u.file));
        a ? (c = a, b && (a = g("a", "display", b), g("div", "icon", a), g("div", "logo", a), c && a.setAttribute(
              "href", l.getAbsolutePath(c))), c = "#" + b.id + " .jwdownload", b.style.width = "", b.style.height =
            "", d(c + "display", {
          ...
          h ? (f = h, b = g("iframe", "", b), b.src = "http://www.youtube.com/embed/" + l.youTubeID(f), b.width = e,
            b.height = r, b.style.border = "none") : c()
      }
    }
  }(jwplayer),
  function (f) {
      ...
      this.embed = function () {
        ...
        if(t + "_wrapper" === c.parentNode.id) f = document.getElementById(t + "_wrapper");
          ...
          if(e.config.aspectratio) {
            ...
            n && ("bottom" === n.position ? j.style.paddingBottom = n.size + "px" : "right" === n.position && (j.style
              .marginBottom = -1 * n.size * (x / 100) + "px"))
          }
        ...
        d.isMSIE() ? (c.outerHTML =
          '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="100%" height="100%" id="' + t +
          '" name="' + t + '" tabindex="0"><param name="movie" value="' +
          g.src +
          '"><param name="allowfullscreen" value="true"><param name="allowscriptaccess" value="always"><param name="seamlesstabbing" value="true"><param name="wmode" value="' +
          n + '"><param name="bgcolor" value="#000000"></object>', f = f.getElementsByTagName("object")[0], f.style
          .outline = "none") : (f = document.createElement("object"), f.setAttribute("type",
            "application/x-shockwave-flash"), f.setAttribute("data", g.src), f.setAttribute("width", "100%"),
          f.setAttribute("height", "100%"), f.setAttribute("bgcolor", "#000000"), f.setAttribute("id", t), f.setAttribute(
            "name", t), f.className = "jwswf", r(f, "allowfullscreen", "true"), r(f, "allowscriptaccess",
            "always"), r(f, "seamlesstabbing", "true"), r(f, "wmode", n), c.parentNode.replaceChild(f, c));
  ...
  function (f) {
    ...
    f.embed = b.extend(function (g) {
      ...
      case "pro":
        j.sharing && (c.test(j.sharing.client) && (w = j.sharing.client), h[w] = j.sharing), j.skin && (l.skin =
          j.skin.replace(/^(beelden|bekle|five|glow|modieus|roundster|stormtrooper|vapor)$/i, b.repo() +
            "skins/$1.xml"))
      }
      l.plugins = h;
      g.config = l;
    ...
    b.controller = function (a, e) {
      ...
      function w(f, g) {
        ...
        if(h.reconcile) {
          ...
          j.id === a.id && (h.appid === G.appid && h.pageUrl === T) && (A || (a.jwInstreamState() && a.jwInstreamDestroy(!
            0), B(k), e.sendEvent(c.JWPLAYER_PLAYER_STATE, {
            oldstate: j.oldstate,
            newstate: j.newstate
          })), P(h));
          H = null
      ...
      function v(a) {
        var c = f.chrome;
        a.code !== c.cast.ErrorCode.CANCEL && (b.log("Cast Session Error:", a, A), a.code === c.cast.ErrorCode.SESSION_ERROR &&
          x())
      }
      ...
      function B(k) {
        ...
        if(A) x(), O = k;
          ...
          a.jwPlayAd = a.jwPauseAd = a.jwSetControls = a.jwForceState = a.jwReleaseState = a.jwSetFullscreen = a.jwDetachMedia =
            a.jwAttachMedia = N;
      ...
      function P(d) {
        if("state" ===
          d.type) {
          if(C && (d.diff.newstate || d.diff.position)) C.destroy(), C = null, e.setVideoProvider(D), e.sendEvent(c
      ...
      l(G, "endscreen");
      l(G, "logo");
      if(G.appid && (!f.cast || !f.cast.receiver)) b.loader.addEventListener("availability", p), b.loader.addEventListener(
        "session", m), b.loader.initialize(G.appid);
  ...
  function (f) {
    ...
    function l(a, b) {
      ...
      if(c.reconcile) {
        ...
        t[c.diff.id] && (v === c.appid && c.pageUrl === B) && (u = c.diff.id, v = c.appid, r(u, "jwInstreamDestroy"),
          g(d), r(u, n.message, c), x = null)
      }
    }
      ...
      w = r.extend({
        initialize: function (a) {
          ...
          null !== e.availability ? w.sendEvent("availability", {
            ...
            "https://www.gstatic.com/cv/js/sender/v1/cast_sender.js"), h.addEventListener(q.ERROR, j), h.addEventListener(
            q.COMPLETE,
            b), h.load())
        }
  ...
  function (f, d) {
    ...
    f.api = function (h) {
      ...
      n.getPlaylist = function () {
        ...
        "flash" === n.renderingMode && b.deepReplaceKeyName(a, ["__dot__", "__spc__", "__dsh__", "__default__"], [
          ".", " ", "-", "default"]);
        return a
      };
      ...
      n.resize = function (a, c) {
        if("flash" !== n.renderingMode) t("jwResize",
          ...
          d && (d.style.display = "block", d.style.width = b.styleDimension(a), d.style.height = b.styleDimension(
            c))
        }
        return n
      };
      ...
      n.pause = function (a) {
        a ===
          d ? (a = n.getState(), a === k.PLAYING || a === k.BUFFERING ? t("jwPause") : t("jwPlay")) : t("jwPause",
            a);
        return n
      };
        ...
        if(d)
          for(var d = d.slice(0), e = b.translateEventResponse(a, c), f = 0; f < d.length; f++) {
            ...
            if("function" === typeof h) try {
              a === j.JWPLAYER_PLAYLIST_LOADED && b.deepReplaceKeyName(e.playlist, ["__dot__", "__spc__",
                "__dsh__", "__default__"], [".", " ", "-", "default"]), h.call(this, e)
            } catch(g) {
