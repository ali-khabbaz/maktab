...
(function (d) {
  ...
  d.parseDimension = function (a) {
    return "string" === typeof a ? "" === a ? 0 : -1 < a.lastIndexOf("%") ? a : parseInt(a.replace("px", ""), 10) :
      a
  };
...
(function (d) {
  ...
  d.stretch = function (a, c, f, e, h, j) {
    ...
    case l.EXACTFIT:
      ...
      break;
    default:
      b > m ? 0.95 < h * m / f ? (k = !0, q = "jwexactfit") : (h *= m, j *= m) : 0.95 < j * b / e ? (k = !0, q =
        "jwexactfit") : (h *= b, j *= b), k && (b = 2 * Math.ceil(f / 2) / h, m = 2 * Math.ceil(e / 2) / j)
    }
    g ? (a = {
        left: "",
        right: "",
        width: "",
        height: ""
      }, k ? (f < h && (a.left = a.right = Math.ceil((f - h) / 2)), e < j && (a.top = a.bottom = Math.ceil((e - j) /
        2)), a.width = h, a.height = j, d.scale(c, b, m, 0, 0)) : (k = !1, d.transform(c)), d.css.style(c, a)) : c.className =
      c.className.replace(/\s*jw(none|exactfit|uniform|fill)/g, "") + " " + q;
    return k
  }
})(jwplayer.utils);
(function (d) {
  d.dfxp = function () {
    ...
    this.parse = function (a) {
      ...
      var f = a.split("</p>"),
        e = a.split("</tt:p>"),
        h = [];
      for(a = 0; a < f.length; a++) 0 <= f[a].indexOf("<p") && (f[a] = f[a].substr(f[a].indexOf("<p") + 2).replace(
        /^\s+/, "").replace(/\s+$/, ""), h.push(f[a]));
      for(a = 0; a < e.length; a++) 0 <= e[a].indexOf("<tt:p") && (e[a] = e[a].substr(e[a].indexOf("<tt:p") + 5).replace(
        /^\s+/, "").replace(/\s+$/, ""), h.push(e[a]));
      f = h;
      for(a = 0; a < f.length; a++) {
        e = f[a];
        h = {};
        try {
          var j = e.indexOf('begin="'),
            e = e.substr(j + 7),
            j = e.indexOf('" end="');
...
(function (d) {
  function l(l) {
    ...
    function r(a) {
      E(a);
      Y && (t.state === e.PLAYING && !T) && (K = Math.floor(10 * I.currentTime) / 10, a && (N = !0), t.sendEvent(f.JWPLAYER_MEDIA_TIME, {
        position: K,
        duration: H
      }))
    }
    ...
    function p(b) {
      Y && !T && (I.paused ? I.currentTime === I.duration && 3 < I.duration || t.pause() : (!a.isFF() || !("play" ===
        b.type && t.state === e.BUFFERING)) && t.setState(e.PLAYING))
    }
    ...
    function A(b, c) {
      ...
      S = 0;
      I.src !== J.file || m || g ?
        (m || t.setState(e.BUFFERING), P = N = !1, H = c ? c : -1, I.src = J.file, I.load()) : (0 === b && (S = -1, t
          .seek(b)), n(), I.play());
      K = I.currentTime;
      m && u();
    ...
    var t = this,
      x = {
        ...
        emptied: s,
        ended: function () {
          Y && t.state !== e.IDLE && (h(W), ea = -1, va = !0, t.sendEvent(f.JWPLAYER_MEDIA_BEFORECOMPLETE), Y && (t
            .setState(e.IDLE), va = !1, t.sendEvent(f.JWPLAYER_MEDIA_COMPLETE)))
        },
        error: function () {
...
(function (d) {
  function l(g) {
    ...
    function u(a) {
      ...
      switch(T) {
      case b.ENDED:
        G.state !== e.IDLE && (W = !0, G.sendEvent(f.JWPLAYER_MEDIA_BEFORECOMPLETE), G.setState(e.IDLE), W = !1, G.sendEvent(
          f.JWPLAYER_MEDIA_COMPLETE));
        break;
      case b.PLAYING:
    ...
    this.mute = function (b) {
      x && x.getVolume && (a.exists(b) || (b = !x.isMuted()), b ? (D = x.getVolume(), x.mute()) : (this.volume(D),
        x.unMute()))
    };
    this.detachMedia = function () {
...
(function (d) {
  ...
  d.html5.adskipbutton = function (h, j, b, d) {
    ...
    function s(a) {
      ...
      a === d && (g -= w.width, b.drawImage(w, y.width - (y.width - b.measureText(d).width) / 2 - 4, (e - w.height) /
        2));
      b.fillText(a, g, c + 4)
    }
    ...
    L.updateSkipTime = function (b, c) {
      ...
      }), 0 < E - b ? (g(b), u && (u = !1, n.style.cursor = "default")) : u || (u || (u = !0, n.style.cursor =
        "pointer"), F ? v() : s()))
    };
...
(function (d) {
  ...
  l.captions = function (h, g) {
    ...
    function E(a) {
      0 < a ? (G = a - 1, J = Math.floor(a), G >= t.length || (t[G].data ? F.populate(t[G].data) : x === t.length ?
        (l("file not loaded: " + t[G].file), 0 !== J && u(c.JWPLAYER_CAPTIONS_CHANGED, t, 0), J = 0) : M = a, n(!
          1))) : (J = 0, n(!1))
    }
    ...
    this.setCurrentCaptions = function (b) {
      0 <= b && (J !== b && b <= t.length) && (E(b), b = p(), a.saveCookie("captionLabel", b[J].label), u(c.JWPLAYER_CAPTIONS_CHANGED,
        b, J))
    };
    ...
    h.jwAddEventListener(c.JWPLAYER_PLAYLIST_ITEM, function () {
      ...
      F.update(0);
      x = 0;
      for(var b = h.jwGetPlaylist()[h.jwGetPlaylistIndex()].tracks, e = [], f = 0, g = "", r = 0, g = "", f = 0; f <
        b.length; f++) g = b[f].kind.toLowerCase(), ("captions" === g || "subtitles" === g) && e.push(b[f]);
      J = 0;
      if(!j) {
...
(function (d) {
  ...
  d.html5.captions.renderer = function (c, f) {
    ...
    function b(a, b, c) {
      ...
      "dropshadow" === a ? b.textShadow = "0 2px 1px " + c : "raised" === a ? b.textShadow = "0 0 5px " + c +
        ", 0 1px 5px " + c + ", 0 2px 5px " + c : "depressed" === a ? b.textShadow = "0 -2px 1px " + c : "uniform" ===
        a && (b.textShadow = "-2px 0 1px " + c + ",2px 0 1px " + c + ",0 -2px 1px " + c + ",0 2px 1px " + c +
          ",-1px 1px 1px " + c + ",1px 1px 1px " +
    ...
    b(E, z, n);
    c.back ? z.backgroundColor = l.hexToRgba(l.rgbHex(u), c.backgroundOpacity) : null === E && b("uniform", z);
  ...
  e.controlbar = function (p, k) {
    ...
    function A(a) {
      ...
      var b = a.duration === Number.POSITIVE_INFINITY,
        ...
        h.isSafari() && !q;
      b || c ? (X.setText(p.jwGetPlaylist()[p.jwGetPlaylistIndex()].title || "Live broadcast"), D(!1)) : (B.elapsed &&
        (b = h.timeFormat(a.position), B.elapsed.innerHTML = b), B.duration && (b = h.timeFormat(a.duration), B.duration
          .innerHTML = b), 0 < a.duration ? Fa(a.position / a.duration) : Fa(0), sa = a.duration, ma || X.setText()
      )
    }
    ...
    function t(a) {
      fa && (Ba = Math.floor(a.track), B.cc && (B.cc.querySelector("button").className = 2 === fa.length && 0 ===
        Ba ? "off" : ""), pa && 0 <= Ba && pa.setActive(a.track))
    }
    ...
    function T(b) {
      h.foreach(ib, function (c, e) {
        c !== b && ("cc" === c && (clearTimeout(Ja), Ja = a), "hd" === c && (clearTimeout(na), na = a), e.hide())
      })
    }

    function D(b) {
      R && B.alt && (b === a && (b = R.parentNode && 320 <= R.parentNode.clientWidth), b && !ma ? g.style(Wa, u) :
        g.style(Wa, y))
    }
    ...
    function Z(a, b) {
      ...
      B[a] && (b ? h.addClass(B[a],
        "jwtoggle") : h.removeClass(B[a], "jwtoggle"), h.addClass(B[a], "jwtoggling"), setTimeout(function () {
    ...
    function da() {
      fa && 2 < fa.length && (jb && (clearTimeout(jb), jb = a), g.block(aa), pa.show(), Ka("cc", pa), T("cc"))
    }
    ...
    function Na(a) {
      if(Ca) {
        var c = B[Ca].querySelector(".jwrail"),
          ...
          c = a.x / c.width;
        100 < c && (c = 100);
        a.type === h.touchEvents.DRAG_END ? (p.jwSeekDrag(!1), B.timeRail.className = "jwrail", Aa(), fb.time(c),
          Xa()) : (Fa(c), a = (new Date).getTime(), 500 < a - lb && (lb = a, fb.time(c)));
    ...
    function pb(a) {
      return function (b) {
        b.button ||
          (B[a + "Rail"].className = "jwrail", "time" === a ? p.jwGetState() !== m.IDLE && (p.jwSeekDrag(!0), La(
            a)) : La(a))
      }
    }
    ...
    function Da(a) {
      if(Ca && !a.button) {
        var b = B[Ca].querySelector(".jwrail"),
          c = h.bounds(b),
          b = Ca,
          c = xa() ? B[b].vertical ? (100 * c.bottom - a.pageY) / (100 * c.height) : (a.pageX - 100 * c.left) / (
            100 * c.width) : B[b].vertical ? (c.bottom - a.pageY) / c.height : (a.pageX - c.left) / c.width;
        "mouseup" === a.type ? ("time" === b && p.jwSeekDrag(!1), B[b + "Rail"].className = "jwrail", Aa(), fb[b.replace(
          "H", "")](c)) : ("time" === Ca ? Fa(c) : Ha(c), a = (new Date).getTime(),
    ...
    function ab(a) {
      ...
      if((ja = h.bounds(Ya)) && 0 !== ja.width) {
        var b;
        xa() ? (a = a.pageX ? a.pageX - 100 * ja.left : a.x, b = 100 * ja.width) : (a = a.pageX ? a.pageX - ja.left :
          a.x, b = ja.width);
    ...
    function Za() {
      h.foreach(gb, function (a, b) {
        ...
        "%" === b.position.toString().slice(-1) ? c.left = b.position : 0 <
          sa ? (c.left = (100 * b.position / sa).toFixed(2) + "%", c.display = null) : (c.left = 0, c.display =
            "none");
        g.style(b.element, c)
      })
    }
    ...
    function hb(c, e, f, g) {
      if(q) {
        ...
        (new h.touch(e)).addEventListener(h.touchEvents.TAP,
          function () {
            var e = f;
            "cc" === g ? (2 === fa.length && (e = ra), Ja ? (clearTimeout(Ja), Ja = a, c.hide()) : (Ja =
              setTimeout(function () {
                c.hide();
                Ja = a
              }, 4E3), e()), X.sendEvent(b.JWPLAYER_USER_ACTION)) : "hd" === g && (2 === ia.length && (e = I),
              na ? (clearTimeout(na), na = a, c.hide()) : (na = setTimeout(function () {
                c.hide();
                na = a
      ...
      if(Sa[a]) {
        ...
        if(b && 0 < b.elements.length)
          for(var j = 0; j < b.elements.length; j++) {
            ...
            a: {
              ...
              case r:
                ...
                if(p.src) {
                  var t = K();
                  t.id = aa + "_" + d;
                  "elapsed" === d || "duration" === d ? (t.className = "jwtext jw" + d + " jwhidden", Wa.push(t)) :
                    t.className = "jwtext jw" + d;
              ...
              case C:
                if("blank" !== d.name) {
                  d = d.name;
                  p = k;
                  if(!U(d + "Button").src || q && ("mute" === d || 0 === d.indexOf("volume")) ||
                    ...
                    k.className = "jw" + d;
                    "left" === p ? (k.appendChild(t), k.appendChild(v)) : (k.appendChild(v), k.appendChild(t));
                    q ? "hd" !== d && "cc" !== d && (new h.touch(m)).addEventListener(h.touchEvents.TAP, S(d)) :
                      m.addEventListener("click", S(d), !1);
                    m.innerHTML = "&nbsp;";
                    m.tabIndex = -1;
                    ...
                    (p = xb[d]) && P(H(".jw" + d + ".jwtoggle button"), U(p + "Button"), U(p + "ButtonOver"));
                ...
                if(q && 0 === v.indexOf("volume")) k = void 0;
                  ...
                  for(var A = 0; A < Y.length; A++) {
                    ...
                    if(D) {
                      ...
                      J && T.appendChild(J);
                      T.appendChild(D);
                      F && (T.appendChild(F), F.className += " jwcap" + (u ? "Bottom" : "Right"));
                      g(H(".jwrailgroup." + Y[A]), {
                      ...
                      2 === A && (E = T);
                      2 === A && !u ? (D = K(), D.className = "jwprogressOverflow", D.appendChild(T), B[M] = D, z
                  ...
                  q ? (u = new h.touch(z), u.addEventListener(h.touchEvents.DRAG_START, Ma), u.addEventListener(h
                    .touchEvents.DRAG,
                    Na), u.addEventListener(h.touchEvents.DRAG_END, Na), u.addEventListener(h.touchEvents.TAP,
                    ob)) : (E = ha, "volume" === E && !u && (E += "H"), z.addEventListener("mousedown", pb(E), !
                    1));
                  "time" === ha && !q && (z.addEventListener("mousemove", kb, !1), z.addEventListener("mouseout",
                    Xa, !1));
                  ha = B[ha + "Rail"] = z;
                  z = U(L + p);
                  L = U(L + p);
                  ...
                  B[v] = d;
                  d.vertical = t;
                  "time" === v ? (ka = new e.overlay(aa + "_timetooltip", V), Ta = new e.thumbs(aa + "_thumb"),
                    Ua = l.createElement("div"), Ua.className = "jwoverlaytext", bb = l.createElement("div"), k =
                    Ta.element(), bb.appendChild(k), bb.appendChild(Ua), ka.setContents(bb), Ya = ha, qb(0), k =
                    ka.element(), ha.appendChild(k), B.timeSliderRail || g.style(B.time, y), B.timeSliderThumb &&
                    g.style(B.timeSliderThumb, {
                      "margin-left": U("timeSliderThumb").width / -2
                    }), k = U("timeSliderCue"), p = {
                      "z-index": 1
                    },
                    k && k.src ? (N("timeSliderCue"), p["margin-left"] = k.width / -2) : p.display = "none", g(
                      H(".jwtimeSliderCue"), p), $a(0), Fa(0), Fa(0), $a(0)) : 0 === v.indexOf("volume") && (v =
                    d, m = "volume" + (t ? "" : "H"), w = t ? "vertical" : "horizontal", g(H(".jw" + m + ".jw" +
                      w), {
                      width: U(m + "Rail", t).width + (t ? 0 : U(m + "Cap" + p).width + U(m + "RailCap" + p).width +
                        U(m + "RailCap" + k).width + U(m + "Cap" + k).width),
                      height: t ? U(m + "Cap" + p).height + U(m + "Rail").height + U(m + "RailCap" + p).height +
                        U(m + "RailCap" + k).height + U(m + "Cap" + k).height : ""
                    }), v.className += " jw" + w);
                  k = d
                }
                d = k;
            ...
            d && ("volume" === b.elements[j].name && d.vertical ? (qa = new e.overlay(aa + "_volumeOverlay", V), qa
              .setContents(d)) : f.appendChild(d))
          }
      }
    }
    ...
    function za(a, b) {
      if(B[a]) {
        var c = B[a].vertical,
          ...
          e = B[e + "Thumb"],
          h;
        d && (h = {}, c ? (h.height = f, h.bottom = 0) : h.width = f, "volume" !== a && (h.opacity = 0 < b || Ca ?
          1 : 0), g.style(d, h));
    ...
    var V, ba = w("divider", "divider"),
      ca = {
        ...
        layout: {
          ...
          right: {
            position: "right",
            elements: [w("duration", r), w("hd", C), w("cc", C), w("mute", C), w("volume", n), w("volumeH", n), w(
              "cast", C), w("fullscreen", C)]
          }
        }
      },
      $, Sa, B, Ia, R, aa, sa, ia = [],
      ...
      fb = {
        time: function (a) {
          db ? (a = db.position, a = "%" === a.toString().slice(-1) ? sa * parseFloat(a.slice(0, -1)) / 100 :
            parseFloat(a)) : a *= sa;
          p.jwSeek(a)
        },
        volume: function (a) {
    ...
    X.redraw = function (a) {
      ...
      (b = Math.floor($.maxwidth)) && R.parentNode && h.isIE() && (!ta && R.parentNode.clientWidth > b + 2 * Math
        .floor($.margin) ? g.style(R, {
          width: b
        }) : g.style(R, {
          width: ""
        }));
    ...
    X.adMode = function (a) {
      if(j.isBoolean(a) && a !== mb) {
        ...
        } else b = Wa, c = B.elapsed, -1 === j.indexOf(b, c) && b.push(c), b = Wa, c = B.duration, -1 === j.indexOf(
          b, c) && b.push(c);
    ...
    X.show = function (a) {
      if(!X.visible || a) X.visible = !0, g.style(R, {
        display: "inline-block"
      }), ya = h.bounds(R), D(), g.block(aa), F(), wa(), clearTimeout(cb), cb = -1, cb = setTimeout(function () {
        g.style(R, {
          opacity: 1
        })
      }, 0)
    ...
    B.cc && (pa = new e.menu("cc", aa + "_cc", V, va), q ? hb(pa, B.cc, da, "cc") : la(pa, B.cc, da, Q), ib.cc = pa);
    B.mute && (B.volume && B.volume.vertical) && (qa = new e.overlay(aa + "_volumeoverlay", V), qa.setContents(B.volume),
      la(qa, B.mute, W), ib.volume = qa);
    g.style(Ea.right, {
      right: U("capRight").width
    });
    vb && R.appendChild(vb);
      ...
      if(!ma) {
        ...
        if(j.isArray(a) && !q)
          for(var e = 0; e < a.length; e++)
            if(!b &&
              (a[e].file && a[e].kind && "thumbnails" === a[e].kind.toLowerCase()) && (Ta.load(a[e].file), b = !
                0), a[e].file && a[e].kind && "chapters" === a[e].kind.toLowerCase()) {
              var f = a[e].file;
...
(function (d) {
  ...
  d.html5.controller = function (e, h) {
    ...
    function C() {
      e.state === c.IDLE && (z ? z = !1 : (p = C, e.repeat ? v() : e.item === e.playlist.length - 1 ? (E = 0, k(!0),
        setTimeout(function () {
...
(function (d) {
  ...
  l.display = function (d, g) {
    ...
    function q(a, b) {
      S.showicons && (a || b ? (K.setRotation("buffer" === a ? parseInt(S.bufferrotation, 10) : 0, parseInt(S.bufferinterval,
          10)), K.setIcon(a),
        K.setText(b)) : K.hide())
    }

    function s(a) {
      A !== a ? (A && E(j, !1), (A = a) ? (a = new Image, a.addEventListener("load", r, !1), a.src = A) : (e("#" +
        u.id + " " + j, {
          "background-image": ""
    ...
    function C(a) {
      ...
      case f.IDLE:
        !x && !M && (A && !G && E(j, !0), a = !0, d._model && !1 === d._model.config.displaytitle && (a = !1), q(
          "play", w && a ? w.title : ""));
        break;
      case f.BUFFERING:
        x = !1;
    ...
    function y() {
      0 < u.clientWidth * u.clientHeight && a.stretch(d.jwGetStretching(), p, u.clientWidth, u.clientHeight, F, L)
    }
    ...
    this.show = function (a) {
      if(K && (a || (N ? N : d ? d.jwGetState() : f.IDLE) !== f.PLAYING)) clearTimeout(H), H = void 0, u.style.display =
        "block", K.show(), J = !1
    };
    this.hide = function () {
      K && (K.hide(), J = !0)
...
(function (d) {
  ...
  d.html5.displayicon = function (h, j, b, m) {
    ...
    this.setText = function (a) {
      var b = w.style;
      w.innerHTML = a ? a.replace(":", ":<br>") : "";
      b.height = "0";
      b.display = "block";
      if(a)
        for(; 2 < Math.floor(w.scrollHeight /
            c.defaultView.getComputedStyle(w, null).lineHeight.replace("px", ""));) w.innerHTML = w.innerHTML.replace(
          /(.*) .*$/, "$1...");
      b.height = "";
      b.display = "";
      s()
    ...
    a("#" + h, N);
    l.isMobile() || (E.overSrc && (N["background-image"] = "url(" + u.overSrc + "), url(" + E.overSrc + "), url(" +
      p.overSrc + ")"), a(".jw-tab-focus #" + h +
...
(function (d) {
  ...
  l.dock = function (d, b) {
    ...
    A.show = function () {
      !A.visible && y && (A.visible = !0, p.style.display = "block", clearTimeout(w), w = setTimeout(function () {
        p.style.opacity = 1
      }, 0))
    };
    ...
    F && (c(k(), {
        ...
        cursor: "pointer",
        border: "none"
      })), c(k("div.button:hover"), m(L)), c(k("div.button:active"), m(G)), c(k("div.button>div"), {
        opacity: C.iconalpha
      }), c(k("div.button:hover>div"), {
        opacity: C.iconalphaover
      }), c(k("div.button:active>div"), {
...
(function (d) {
  ...
  l.instream = function (j, b, m, g) {
    ...
    D.init = function () {
      ...
      J = b.playlist[b.item];
      x = t.currentTime;
      g.checkBeforePlay() || 0 === x && !b.getVideo().checkComplete() ? (x = 0, M = e.PLAYING) : M = b.getVideo()
        .checkComplete() ? e.IDLE : j.jwGetState() === e.IDLE ? e.IDLE : e.PLAYING;
      M === e.PLAYING && t.pause();
      P = new l.display(D);
...
(function (d) {
  var l = d.utils,
    ...
    f = d.html5.logo = function (e, h) {
      ...
      var v = "o";
      b.edition && (v = b.edition(), v = "pro" === v ? "p" : "premium" === v ? "r" : "ads" === v ? "a" : "free" === v ?
        "f" : "o");
      if("o" === v || "f" === v) q.link = "http://www.longtailvideo.com/jwpabout/?a=l&v=" + d.version + "&m=h&e=" + v;
      g = l.extend({}, q, h);
...
(function (d) {
  ...
  l.model = function (f, e) {
    ...
    s[c.JWPLAYER_PLAYER_STATE] = ["newstate->state"];
    s[c.JWPLAYER_MEDIA_BUFFER] = ["bufferPercent->buffer"];
    ...
    j.setItem =
      function (a) {
        var b = !1;
        a === j.playlist.length || -1 > a ? (a = 0, b = !0) : a = -1 === a || a > j.playlist.length ? j.playlist.length -
          1 : a;
        if(b || a !== j.item) j.item = a, j.sendEvent(c.JWPLAYER_PLAYLIST_ITEM, {
          index: j.item
        }), b = j.playlist[a], a = l.chooseProvider(b && b.sources && b.sources[0]), k instanceof a || (k = e ||
          new a(j.id), j.setVideoProvider(k)), k.init && k.init(b)
      };
  ...
  d.html5.overlay = function (c, d, k) {
    ...
    n.constrainX = function (b, c) {
      if(n.showing && 0 !== b.width && n.offsetX(0)) {
        c && a.unblock();
        var d = l.bounds(p);
        0 !== d.width && (d.right > b.right ? n.offsetX(b.right - d.right) : d.left < b.left && n.offsetX(b.left -
          d.left))
      }
    };
...
(function (d) {
  ...
  a.playlistcomponent = function (d, b) {
    ...
    w.itemImage ? (L = (z - w.itemImage.height) / 2 + "px ", G = w.itemImage.width, t = w.itemImage.height) : (G =
      4 * z / 3, t = z);
    ...
    q.jwAddEventListener(c.JWPLAYER_PLAYLIST_LOADED, function () {
      r.innerHTML = "";
      for(var b = q.jwGetPlaylist(), c = [], d = 0; d < b.length; d++) b[d]["ova.hidden"] || c.push(b[d]);
      if(n = c) {
        b = g("ul", "jwlist");
        b.id = C.id + "_ul" +
        ...
        for(b = 0; b < n.length; b++) {
          var j = b,
            ...
            l = void 0;
          d.id = y.id + "_item_" + j;
          0 < j ? (l = g("div", "jwplaylistdivider"), d.appendChild(l)) : (j = w.divider ? w.divider.height : 0,
            d.style.height = z - j + "px", d.style["background-size"] = "100% " + (z - j) + "px");
          j = g("div", "jwplaylistimg jwfill");
          l = void 0;
          c["playlist.image"] && w.itemImage ? l = c["playlist.image"] : c.image && w.itemImage ? l = c.image :
            w.itemImage && (l = w.itemImage.src);
          ...
          j.appendChild(l);
          c.description && !A && (l = g("span", "jwdescription"), l.innerHTML = c.description, j.appendChild(l));
          d.appendChild(j);
          c = d;
  ...
  d.playlistslider = function (d, b, l, g) {
    ...
    function v(a) {
      if(x) return a = a ? a : h.event, Z(L - (a.detail ? -1 * a.detail : a.wheelDelta / 40) / 10), a.stopPropagation &&
        a.stopPropagation(), a.preventDefault ? a.preventDefault() : a.returnValue = !1, a.cancelBubble = !0, a.cancel = !
        0, !1
    }
    ...
    z.id = d;
    d = new a.touch(p);
    b ? d.addEventListener(c.DRAG, r) : (z.addEventListener("mousedown", C, !1), z.addEventListener("click", n, !1));
    M = s("sliderCapTop");
    J = s("sliderCapBottom");
    H = s("sliderRail");
...
(function (d) {
  ...
  d.rightclick = function (a, h) {
    ...
    var m, g = l.extend({
        aboutlink: "http://www.longtailvideo.com/jwpabout/?a=r&v=" + d.version + "&m=h&e=o",
    ...
    m.oncontextmenu = function (a) {
      var b, c;
      k || (a = a || window.event, b = a.target || a.srcElement, c = l.bounds(m), b = l.bounds(b), q.style.display =
        f, q.style.left = (a.offsetX ? a.offsetX : a.layerX) + b.left - c.left + "px", q.style.top = (a.offsetY ?
          a.offsetY : a.layerY) + b.top - c.top + "px", q.style.display = "block", a.preventDefault())
    };
    ...
    var q = h,
      ...
      y = {
        method: function () {
          ...
          "array" === c ? (c = new d.playlist(e.config.playlist), e.setPlaylist(c), 0 === e.playlist.length || 0 ===
            e.playlist[0].sources.length ? k("Error loading playlist: No playable sources found") : b(y)) : k(
  ...
  d.skinloader = function (c, f, e) {
    ...
    function m(a, b) {
      ...
      c.onload = function () {
        ...
        e ? (e.height = Math.round(c.height / y * n), e.width = Math.round(c.width / y * n), e.src = c.src, e.ready = !
          0, g()) : l.log("Loaded an image for a missing element: " + a + "." + d)
      };
      c.onerror = function () {
...
(function (d) {
  ...
  d.html5.thumbs = function (f) {
    ...
    this.load = function (a) {
      ...
      k && (k.onload = null, k.onreadystatechange = null, k.onerror = null, k.abort && k.abort(), k = null);
      v && (v.onload = null);
      a ? (g = a.split("?")[0].split("/").slice(0, -1).join("/"), k = l.ajax(a, e, h, !0)) : (m = q = v = null, s = {})
    };
    this.element = function () {
      return b
    };
  ...
  a.view = function (r, n) {
    ...
    function A() {
      ...
      if(document.body.contains(Q)) {
        if(c && e && (c !== Ka || e !== $a)) Ka = c, $a = e, V && V.redraw(), clearTimeout(Ba), Ba = setTimeout(W,
          50), ja.sendEvent(f.JWPLAYER_RESIZE, {
          width: c,
          height: e
        })
    ...
    function F(a) {
      a && (a.element().addEventListener("mousemove", J, !1), a.element().addEventListener("mouseout", H, !1))
    }
    ...
    function S(a, b, d) {
      ...
      V && V.redraw();
      O && O.redraw(!0);
      $ && ($.offset(O && 0 <= $.position().indexOf("bottom") ? O.height() + O.margin() : 0), setTimeout(function () {
        ca && ca.offset("top-left" === $.position() ? $.element().clientWidth + $.margin() : 0)
      }, 500));
      R = T(b);
      ...
      if(Ia && f && ("right" === g || "bottom" === g)) Ia.redraw(), e = {
        display: C
      }, d = {}, e[g] = 0, d[g] = f, "right" === g ? e.width = f : e.height = f, h.style(Ra, e), h.style(Ga, d);
      W(a, b);
      h.unblock(j)
    }
    ...
    function Z(a) {
      void 0 !== a.jwstate ? a = a.jwstate : ya ? (a = document.fullscreenElement || document.webkitCurrentFullScreenElement ||
          document.mozFullScreenElement || document.msFullscreenElement, a = !!(a && a.id === r.id)) : a = ua ? U.getVideo()
        .getFullScreen() :
    ...
    function da(a) {
      n.setFullscreen(a);
      U && U.setFullscreen(a);
      a ? (clearTimeout(Ba), Ba = setTimeout(W, 200)) : m && r.jwGetState() === e.PAUSED && setTimeout(La, 500)
    }
    ...
    function Xa(a) {
      if(n.getVideo().isCaster) V && (V.show(), V.hidePreview(!1)), h.style(ga, {
        ...
        case e.PLAYING:
          ...
          (ua ? U : n).getVideo().isAudioFile() ? (Na(!1), V.hidePreview(R), V.setHiding(!0), O && (Ma(), O.hideFullscreen(!
            0)), ra()) : (Na(!0), W(), V.hidePreview(!0), O && O.hideFullscreen(!n.getVideo().supportsFullscreen()));
          break;
        case e.IDLE:
          Na(!1);
    ...
    this.setup = function (j) {
      if(!aa) {
        ...
        n.playlistsize && (n.playlistposition && n.playlistposition !== v) && (Ia = new a.playlistcomponent(r, {}),
          Ra.appendChild(Ia.element()));
        ...
        d.addEventListener("resize",
          A, !1);
        b && (d.removeEventListener("orientationchange", A), d.addEventListener("orientationchange", A, !1));
        ...
        r.jwAddEventListener(f.JWPLAYER_CAST_SESSION, function (a) {
          ...
          a.active ? (h.style(B.element(), {
            display: "none"
          }), ja.forceControls(!0), ba.setState("connecting").setName(a.deviceName).show(), r.jwAddEventListener(
            f.JWPLAYER_PLAYER_STATE, ba.statusDelegate), r.jwAddEventListener(f.JWPLAYER_CAST_AD_CHANGED,
            N)) : (r.jwRemoveEventListener(f.JWPLAYER_PLAYER_STATE,
              ba.statusDelegate), r.jwRemoveEventListener(f.JWPLAYER_CAST_AD_CHANGED, N), ba.hide(), O.adMode() &&
            P(), h.style(B.element(), {
              display: null
            }), Da({
              newstate: r.jwGetState()
        ...
        b || (la.addEventListener("mouseout", G, !1), la.addEventListener("mousemove", M, !1), c.isMSIE() && (ga.addEventListener(
          "mousemove", M, !1), ga.addEventListener("click", V.clickHandler)));
        F(O);
        F(ca);
        F($);
        h("#" + Q.id + "." + k + " .jwaspect", {
    ...
    var ka = this.fullscreen = function (a) {
      ...
      a = !!a;
      a !== n.fullscreen && (ya ? (a ? Qa.apply(Q) : qa.apply(document), Y(Q, a)) : c.isIE() ? Y(Q, a) : (U && U.getVideo()
        .setFullScreen(a), n.getVideo().setFullScreen(a)))
    };
    ...
    this.setControls = function (a) {
      var b = !!a;
      b !== n.controls && (n.controls = b, ua ? a ? (Ha.show(), Fa.show()) : (Ha.hide(), Fa.hide()) : b && Da({
        newstate: r.jwGetState()
    ...
    this.destroy =
      function () {
        ...
        fa && fa.destroy();
        ba && (r.jwRemoveEventListener(f.JWPLAYER_PLAYER_STATE, ba.statusDelegate), ba.destroy(), ba = null);
    ...
    qa = document.exitFullscreen || document.webkitExitFullscreen || document.webkitCancelFullScreen || document.mozCancelFullScreen ||
  ...
  j.castDisplay = function (q) {
    ...
    s || (k(".jwplayer .jwcast-display", {
      ...
      k(".jwplayer .jwcast-label", {
        ...
        opacity: 1
      }), h.cssKeyframes("spin", "from {transform: rotate(0deg);} to {transform: rotate(360deg);}"), k(
        ".jwcast-connecting .jwcast-wheel, .jwcast-buffering .jwcast-wheel", {
          opacity: 1,
    ...
    this.setCompanions = function (a) {
      ...
      for(d = a.length; d--;)
        ...
        }(a = h) ? (null === H && (H = c("div", "companion"), e(u, H)), a.width / a.height > v ? (b = 316, d =
          a.height * b / a.width) : (d = 176,
    ...
    this.adChanged = function (a) {
      if(a.complete) J && J.reset(-1), M = null;
        ...
        J && (void 0 === a.skipoffset ? m() : (a.position || a.duration) && J.updateSkipTime(a.position | 0, a.duration |
          0));
        var b = a.tag + a.sequence;
        b !== M && (k(t + " .jwpreview", {
          opacity: 0
        }), a.companions ? this.setCompanions(a.companions) : y(), a.clickthrough ? null === K && (K = c(
          "div", "click-label"), K.innerText = "Click here to learn more >", e(u, K)) : n(), M = b, this.setState(
          a.newstate))
      }
    };
...
(function (d) {
  ...
  d.rightclick = function (c, f) {
    if("free" == c.edition()) f.aboutlink = "http://www.longtailvideo.com/jwpabout/?a=r&v=" + d.version +
      "&m=h&e=f", delete f.abouttext;
    else {
      if(!f.aboutlink) {
        var e = "http://www.longtailvideo.com/jwpabout/?a=r&v=" + d.version + "&m=h&e=",
          h = c.edition();
        f.aboutlink = e + ("pro" == h ? "p" : "premium" == h ? "r" : "enterprise" == h ? "e" : "ads" == h ? "a" :
          "f")
      }
...
(function (d) {
  ...
  l.adprovider = function (c, f) {
    ...
    b.updateModel = function (a, b) {
      ...
      a.tag && (m.tag && a.tag !==
        m.tag) && (l.error("ad messages not received in order. new model:", a, "old model:", m), e());
      d.utils.extend(m, a);
      j.updateModel(a, b)
    };
    b.getAdModel = function () {
      ...
      if(0 < m.duration) {
        ...
        c.podMessage && 1 < c.podcount && (d = c.podMessage.replace(/__AD_POD_CURRENT__/g, "" + c.sequence).replace(
          /__AD_POD_LENGTH__/g, "" + c.podcount) + d);
        b.message = d
      } else b.message = g;
      return b
    };
...
(function (d) {
  ...
  l.provider = function (d) {
    ...
    b.updateModel = function (a, d) {
      ...
      if("ad" !== d) {
        if(void 0 !== a.position || void 0 !== a.duration) void 0 !== a.position && (g.position = a.position),
          void 0 !== a.duration && (g.duration = a.duration), b.sendEvent(c.JWPLAYER_MEDIA_TIME, {
            position: g.position,
            duration: g.duration
          });
